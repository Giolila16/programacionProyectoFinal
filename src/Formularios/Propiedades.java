...
// Constructor SIN imagen (por si no la tienes todavía)
public Propiedades(String id, String tipo, String ubicacion, String area, String precio,
                   String estado, String propietario, String agente) {
    this(id, tipo, ubicacion, area, precio, estado, propietario, agente, ""); // ruta vacía
}
...
public String getRuta() { return rutaImagen; }
    ...
    public static void cargarCasasEjemplo() {
        ...
        listaCasas.add(new Propiedades("02405", "Casa", "Zulia", "8", "20000", "Mantenimiento", "Sebastian", "Jose"));
        ...
        listaCasas.add(new Propiedades("02408", "Local", "El Pórtico", "20", "50000", "Disponible", "Claudia", "Andrés"));
